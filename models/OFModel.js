...
const ofModelSchema = new mongoose.Schema({
...
// Indexes
ofModelSchema.index({ email: 1 });
ofModelSchema.index({ username: 1 });
ofModelSchema.index({ 'content.platforms': 1 });

module.exports = mongoose.model('OFModel', ofModelSchema);